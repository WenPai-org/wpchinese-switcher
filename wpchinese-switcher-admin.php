      ...
      <div class="wrap">
          ...
          <table class="form-table">
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_nt');">自定义"不转换"标签名: </a></td>
              <td><!--wpcs_NC_START-->
                <input type="text" style="width: 100px;" name="wpcso_no_conversion_tip" id="wpcso_no_conversion_tip"
                       value="<?php echo esc_html($this->options['nctip']); ?>"/><!--wpcs_NC_END-->
                <div id="wpcs_help_nt" style="display: none;">本插件输出的widget中将包含当前页面原始版本链接, 您可以在这里自定义其显示的名称.
                  如果留空则使用默认的"不转换".
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_uls');">对下面几种中文开启转换功能:</a></td>
              <td><!--wpcs_NC_START-->
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_ua');">识别浏览器中文语言动作:</a></td>
              <td>
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_co');">使用Cookie保存并识别用户语言偏好:</a></td>
              <td>
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_nc');">不转换文章中某些HTML标签里中文:</a></td>
              <td>
                <input type="text" value="<?php echo $this->options['wpcs_no_conversion_tag']; ?>" style="width: 250px;"
                       name="wpcso_no_conversion_tag" id="wpcso_no_conversion_tag"/> (默认空)
                <div id="wpcs_help_nc" style="display: none;">这里输入的HTML标签里内容将不进行中文繁简转换(仅适用文章内容), 保持原样输出. 请输入HTML标签名,
                  如<code>pre</code>;
                  多个HTML标签之间以 <code>,</code> 分割, 如 <code>pre,code</code>. 支持部分基本的<a
                          href="http://www.w3schools.com/cssref/css_selectors.asp"
                          target="_blank">CSS选择器</a>的DOM筛选语法，如<code>div.nocc</code>,
                  <code>.class1,div#para1</code>, <code>table,span.nocc,div[attr="hello"]</code>. 如果遇到html错误, 请关闭此选项.
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_nc_ja');">不转换日语(lang="ja")的HTML标签里内容:</a>
              </td>
              <td>
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_pl');">繁简转换页面永久链接格式:</a></td>
              <td>
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_ob');">对页面内容整体转换:</a></td>
              <td>
            ...
            <tr>
              <td><input class="button" type="submit" name="submit" value="保存选项"/></td>
            </tr>
            </tbody>
          </table>
        </form>
            ...
            <table class="form-table">
              ...
              <tr>
                <td valign="top" colspan="2">
                  <div style="width: 800px;">默认情况下, 本插件的"识别浏览器中文语言动作"和"使用Cookie保存并识别用户语言偏好"这两个功能与缓存插件不兼容.
                    如果您使用的是<a href="http://wordpress.org/extend/plugins/wp-super-cache/">WP Super Cache</a>的"Legacy page
                    caching"缓存模式,
                    您可以点击下面的按钮安装WP Super Cache兼容. <b>注意: 如果您没有开启"识别浏览器中文语言动作"和"使用Cookie保存并识别用户语言偏好"这两个功能(默认均为关闭),
                      ...
                      不支持"PHP Cache"和"mod_rewrite cache"模式. (WP Super Cache 插件安装后默认为"PHP Cache"模式,
                      您必须手动切换到"Legacy"模式.)</b></div>
                </td>
              </tr>
              <tr>
                <td>
        ...
        <form id="wpcso_uninstall_form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
          <table class="form-table">
            ...
            <tr>
              <td valign="top" width="30%"><a title="单击查看帮助" style="cursor: pointer;"
                                              onclick="toggleVisibility('wpcs_help_uninstall');">确定卸载本插件?</a></td>
              <td>
                <input type="checkbox" name="wpcso_uninstall_nonce" id="wpcso_uninstall_nonce" value="1"/> <label
                        for="wpcso_uninstall_nonce">确认卸载 (此操作不可逆)</label>
                <div id="wpcs_help_uninstall" style="display: none;">这将清除数据库options表中本插件的设置项(键值为wpcs_options),
                  提交后还需要到wordpress插件管理菜单里禁用本插件.
                </div>
              </td>
            </tr>
            <tr>
